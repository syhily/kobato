...
export function loader({ request, context }: Route.LoaderArgs) {
  ...
  // Per-request CSP nonce generated by the Hono middleware pipeline.
  // Threaded through the loader so the Layout can apply it to any
  // inline scripts (e.g. RouteWarmupScript).
