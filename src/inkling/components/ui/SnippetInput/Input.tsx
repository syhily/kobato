...
export const Input = ({
  ...
  return (
    <div className="dark:bg-grey-950 relative m-0 flex items-center justify-evenly gap-1 rounded-lg bg-white font-sans text-md font-normal text-black shadow-md">
      <input
        autoComplete="off"
        autoFocus={true}
      ...
      <button
        ...
        onClick={onClear}
      >
        <CloseIcon className="text-grey size-3 stroke-2" />
      </button>
    </div>
  )
}
