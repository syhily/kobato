import AudioPlaceholderIcon from '@/inkling/assets/icons/inkling-audio-placeholder.svg?react'
...
import ProductPlaceholderIcon from '@/inkling/assets/icons/inkling-product-placeholder.svg?react'
import VideoPlaceholderIcon from '@/inkling/assets/icons/inkling-video-placeholder.svg?react'
...
const ButtonContents = ({ desc, hasErrors }: { desc?: string; hasErrors?: boolean }) => {
  ...
  return <p className="text-grey-900 !font-sans !text-[1.3rem] !font-medium">{desc}</p>
}
