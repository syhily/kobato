...
/* c8 ignore start */
import type { ElementTransformer, ExportChildren } from '@/inkling/html/renderer/transformers/index'

import { getTableCellTag } from '@/inkling/nodes/table/table-facts'
import { $isTableCellNode, $isTableNode, $isTableRowNode } from '@/inkling/nodes/table/TableNodes'
/* c8 ignore stop */
