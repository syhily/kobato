...
import type { LexicalProviderFactory } from '@/inkling/context/InklingCollaborationContext'
...
export function createLazyProviderFactory(
  load: LoadCollaborationChunk = () => import('@/inkling/utils/services/collaboration'),
