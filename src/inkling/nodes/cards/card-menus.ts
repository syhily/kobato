import type { CardIconId, CardMenuEntrySpec } from '@/inkling/nodes/cards/card-declaration'
import type { CardFacts } from '@/inkling/nodes/cards/card-facts'
import type { MenuItem } from '@/inkling/nodes/cards/card-menu-build'
import type { HostCardMenuEntrySpec } from '@/inkling/nodes/cards/host-card-registry'
...
import CodeBlockIcon from '@/inkling/assets/icons/inkling-card-type-gen-embed.svg?react'
import GIFIcon from '@/inkling/assets/icons/inkling-card-type-gif.svg?react'
...
import MathCardIcon from '@/inkling/assets/icons/inkling-card-type-math.svg?react'
import ToggleIcon from '@/inkling/assets/icons/inkling-card-type-toggle.svg?react'
import VideoCardIcon from '@/inkling/assets/icons/inkling-card-type-video.svg?react'
import { resolveCardMenuCommand } from '@/inkling/nodes/cards/card-commands'
 ...
 * `defineCard` (`@/inkling/nodes/cards/host-cards`): host menu entries may name a
