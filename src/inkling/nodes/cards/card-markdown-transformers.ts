...
import { $createAudioNode, type AudioNode } from '@/inkling/nodes/AudioNode'
import { getNestedEditorSpecs } from '@/inkling/nodes/base/card-specs'
import { $createBookmarkNode, type BookmarkNode } from '@/inkling/nodes/BookmarkNode'
import { $createButtonNode, type ButtonNode } from '@/inkling/nodes/ButtonNode'
import { $createCalloutNode, type CalloutNode } from '@/inkling/nodes/CalloutNode'
import { type CARD_DECLARATIONS, type CardNodeType } from '@/inkling/nodes/cards'
import { CARD_WRAPPER_NODES } from '@/inkling/nodes/cards/card-wrappers'
import { $createFileNode, type FileNode } from '@/inkling/nodes/FileNode'
import { $createGalleryNode, type GalleryNode } from '@/inkling/nodes/GalleryNode'
import { $createHtmlNode, type HtmlNode } from '@/inkling/nodes/HtmlNode'
import { $createImageNode, $isImageNode, ImageNode } from '@/inkling/nodes/ImageNode'
import { $createToggleNode, type ToggleNode } from '@/inkling/nodes/ToggleNode'
import { $createVideoNode, type VideoNode } from '@/inkling/nodes/VideoNode'

/**
 * The per-card markdown transformer vocabulary, attached to the card
 * declarations one layer up (mirroring `@/inkling/nodes/cards/card-wrappers`): a
 ...
 * Exported for `defineCard` (`@/inkling/nodes/cards/host-cards`): a host card's
 ...
 * (`@/inkling/nodes/cards/host-cards`), which builds host fence transformers through
 ...
 * `@/inkling/markdown/round-trip` derives `MARKDOWN_NODES` and `CARD_TRANSFORMERS`
 * from this list.
 *
