...
import type { DecorateTargetSpec } from '@/inkling/nodes/cards/card-declaration'

import { renderHorizontalRuleCard } from '@/inkling/components/ui/cards/HorizontalRuleCard'
import { renderAudioCard } from '@/inkling/nodes/AudioNodeComponent'
import { renderBookmarkCard } from '@/inkling/nodes/BookmarkNodeComponent'
import { renderButtonCard } from '@/inkling/nodes/ButtonNodeComponent'
import { renderCalloutCard } from '@/inkling/nodes/CalloutNodeComponent'
import { CARD_DECLARATIONS, type CardNodeType } from '@/inkling/nodes/cards'
import { resolveCardFacts, type CardFacts } from '@/inkling/nodes/cards/card-facts'
import { renderCodeBlockCard } from '@/inkling/nodes/CodeBlockNodeComponent'
import { renderFileCard } from '@/inkling/nodes/FileNodeComponent'
import { renderFootnoteDefinitionCard } from '@/inkling/nodes/FootnoteDefinitionNodeComponent'
import { renderGalleryCard } from '@/inkling/nodes/GalleryNodeComponent'
import { renderHeaderCard } from '@/inkling/nodes/header/HeaderNodeComponent'
import { IndicatorIcon as HtmlIndicatorIcon, renderHtmlCard } from '@/inkling/nodes/HtmlNodeComponent'
import { renderImageCard } from '@/inkling/nodes/ImageNodeComponent'
import { renderMathCard } from '@/inkling/nodes/MathNodeComponent'
import { renderToggleCard } from '@/inkling/nodes/ToggleNodeComponent'
import { renderVideoCard } from '@/inkling/nodes/VideoNodeComponent'
 ...
 * the only card with one). The shared adapter (`@/inkling/nodes/decorate-card`)
