...
import {
  ...
  footnoteAnchorId,
  footnoteRefHref,
} from '@/inkling/nodes/footnote/footnote-anchors'
 ...
 * `@/inkling/html/renderer/convert-to-html-string`. Anchors come from the single
 * contract owner (`@/inkling/nodes/footnote/footnote-anchors`).
 */
