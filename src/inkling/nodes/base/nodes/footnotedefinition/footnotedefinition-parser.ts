...
import { createFootnoteTargetKey, resolveImportedFootnoteTargetKey } from '@/inkling/nodes/footnote/footnote-keys'
...
// recast per import (see `@/inkling/nodes/footnote/footnote-keys`).
