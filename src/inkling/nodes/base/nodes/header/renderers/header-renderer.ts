import { isSafeColorValue, type RenderContext } from '@/inkling/nodes/base/render-context'
...
import { slugify } from '@/inkling/utils/slugify'
...
export function renderHeaderNodeV2(nodeData: HeaderV2NodeData, context: RenderContext) {
  ...
  if (!isDivElement(rootElement)) {
    throw new Error('renderHeaderV2Node must render a div root element')
  }

  return { element: rootElement, type: 'outer' as const }
}
