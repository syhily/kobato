...
import type { FootnoteDefinitionNode } from '@/inkling/nodes/FootnoteDefinitionNode'

import InklingNestedEditor from '@/inkling/components/InklingNestedEditor'
import { useFootnoteHandle, useFootnoteHandleState } from '@/inkling/context/FootnoteHandleContext'
import { useInklingLabels } from '@/inkling/hooks/useInklingLabels'
import { $removeFootnote } from '@/inkling/plugins/behaviour/footnotes'
