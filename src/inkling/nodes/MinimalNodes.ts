...
// Deep imports (not the `@/inkling/nodes/base` barrel): the barrel derives its node
...
import { EXTENDED_TEXT_NODE_PAIR } from '@/inkling/nodes/base/nodes/extended-node-pairs'
