...
import { footnoteAnchorHref, footnoteRefId } from '@/inkling/nodes/footnote/footnote-anchors'
import { resolveImportedFootnoteTargetKey } from '@/inkling/nodes/footnote/footnote-keys'
 ...
 * engine (`@/inkling/plugins/behaviour/footnotes`) rewrites the text in place, so no
...
export class FootnoteRefNode extends TextNode {
  ...
  // inline-markup-entity protocol (`@/inkling/nodes/base/export-dom`).
