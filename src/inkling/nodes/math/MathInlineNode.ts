...
import { applyArtifactSlotInvalidation } from '@/inkling/nodes/base/generate-decorator-node'
import { resolveMathArtifact } from '@/inkling/nodes/base/nodes/math/math-artifacts'
import { createRenderContext, MATH_HTML_CONFIG } from '@/inkling/nodes/base/render-context'
 ...
 * (`@/inkling/plugins/behaviour/math-inline`).
 */
