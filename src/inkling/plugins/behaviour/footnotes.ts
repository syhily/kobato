...
import type { FootnoteHandle } from '@/inkling/plugins/behaviour/footnoteHandle'

import { $isCodeBlockNode } from '@/inkling/nodes/base/nodes/codeblock/CodeBlockNode'
import {
  $isFootnoteDefinitionNode,
  type BaseFootnoteDefinitionNode,
} from '@/inkling/nodes/base/nodes/footnotedefinition/FootnoteDefinitionNode'
import { createFootnoteTargetKey } from '@/inkling/nodes/footnote/footnote-keys'
import {
  $createFootnoteRefNode,
  $isFootnoteRefNode,
  type FootnoteRefNode,
} from '@/inkling/nodes/footnote/FootnoteRefNode'
import { $createFootnoteDefinitionNode } from '@/inkling/nodes/FootnoteDefinitionNode'
import { registerUpdateScan } from '@/inkling/plugins/behaviour/update-scan'
import { getRegisteredNodeMap, isNestedEditor } from '@/inkling/utils/lexical-internals'
