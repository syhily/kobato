...
import { dispatchEditMathInlineAtTarget, registerMathInlineEnter } from '@/inkling/plugins/behaviour/math-inline'
 ...
 * `@/inkling/plugins/behaviour/math-inline`; the editing UI they trigger is the
 * host's own.
 */
