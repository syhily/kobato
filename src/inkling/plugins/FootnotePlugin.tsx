...
import { useFootnoteHandle } from '@/inkling/context/FootnoteHandleContext'
import { publishFootnoteMaps, registerFootnotes } from '@/inkling/plugins/behaviour/footnotes'

/**
 * The React adapter for the footnote behaviour module
 * (`@/inkling/plugins/behaviour/footnotes`): feeds the per-composer footnote handle
