...
import { useTKHandle, useTKHandleState } from '@/inkling/context/TKHandleContext'
import { useInklingTextEntity } from '@/inkling/hooks/useInklingTextEntity'
import { $createTKNode, ExtendedTextNode, TKNode } from '@/inkling/nodes/base'
import { resolveTkIndicatorPosition } from '@/inkling/plugins/behaviour/tk-indicator'
import { getTKMatch } from '@/inkling/plugins/behaviour/tk-matcher'
import {
  $selectTkFromIndicator,
  applyTkHoverHighlight,
  registerTkNodeTracking,
} from '@/inkling/plugins/behaviour/tk-tracking'
import { themeClassList } from '@/inkling/themes/inkling-theme-classes'
import { getEditorTheme } from '@/inkling/utils/lexical-internals'
...
function TKIndicator({
  ...
  return (
    <div
      className="text-2xs text-grey-600 absolute cursor-pointer p-1 font-medium"
