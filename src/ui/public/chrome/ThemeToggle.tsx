...
// Glyph describes the action (Moon → dark, Sun → light); both icons stay in the DOM so
// noscript dark-OS visitors get the right icon pre-hydration (`dark:` swaps via opacity + scale).
