 ...
 *
 * Static objects hoisted to module scope — CodeMirror tracks extensions by
 * reference identity, so recreating them on every render forces expensive
 * reconfiguration.
 */
...
export const lightCSS = EditorView.theme({
  ...
  '&.cm-editor .cm-content': { padding: '7px 0' },
  '&.cm-editor .cm-content, &.cm-editor .cm-gutter': { minHeight: '170px' },
  ...
  '&.cm-editor .cm-lineNumbers': { padding: '0' },
  '&.cm-editor .cm-foldGutter': { width: '0' },
  '&.cm-editor .cm-line': {
    padding: '0 .8rem',
    color: '#394047',
    fontFamily: 'Consolas,Liberation Mono,Menlo,Courier,monospace;',
  ...
  '&.cm-editor .cm-activeLine, &.cm-editor .cm-activeLineGutter': { background: 'none' },
  '&.cm-editor .cm-cursor, &.cm-editor .cm-dropCursor': { borderLeft: '1.2px solid black' },
})
...
export const darkCSS = EditorView.theme({
  ...
  '&.cm-editor .cm-activeLine, &.cm-editor .cm-activeLineGutter': { background: 'none' },
  '&.cm-editor .cm-cursor, &.cm-editor .cm-dropCursor': { borderLeft: '1.2px solid white' },
})
...
export const lightBaseExtensions = [syntaxHighlighting(lightHighlightStyle), lightCSS, ...sharedExtensions]

export const darkBaseExtensions = [syntaxHighlighting(darkHighlightStyle), darkCSS, ...sharedExtensions]
