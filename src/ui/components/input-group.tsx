  ...
  return (
    <fieldset
      ...
      className={cn(
        ...
        // Focus state.
        'has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-(--ring-width) has-[[data-slot=input-group-control]:focus-visible]:ring-ring/50',
        // Error state.
