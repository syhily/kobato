...
export function Calendar({
  ...
  const mergedClassNames = useMemo(
    () => ({
      ...
      dropdown_root: cn(
        'relative rounded-md border border-input shadow-xs has-focus:border-ring has-focus:ring-(--ring-width) has-focus:ring-ring/50',
