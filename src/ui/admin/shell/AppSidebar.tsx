...
export function AppSidebar({ currentUser, siteTitle, pendingCommentCount, userCount }: AppSidebarProps) {
  return (
    <Sidebar collapsible="none">
      <AppSidebarHeader className="px-8 pt-10 pb-0" siteTitle={siteTitle} />
      <AppSidebarContent role={currentUser.role} pendingCommentCount={pendingCommentCount} userCount={userCount} />
