// Constants shared across the cache settings UI (form, validators, display) without circular imports.
...
// Mirror of the server-side conflict checks in `cacheSchema` — UX hints only; the server stays authoritative.
