...
import { $createAsideNode, $isAsideNode } from '@/ui/inkling-editor/nodes/AsideNode'
import { $isInklingCard } from '@/ui/inkling-editor/nodes/base'
import { $createBookmarkNode } from '@/ui/inkling-editor/nodes/BookmarkNode'
import { $createCodeBlockNode } from '@/ui/inkling-editor/nodes/CodeBlockNode'
import { $isHtmlNode } from '@/ui/inkling-editor/nodes/HtmlNode'
import {
  MIME_TEXT_HTML,
  MIME_TEXT_PLAIN,
  PASTE_MARKDOWN_COMMAND,
} from '@/ui/inkling-editor/plugins/MarkdownPastePlugin'
import { registerDefaultTransforms } from '@/ui/inkling-editor/transforms'
import {
  $isAtStartOfDocument,
  $isAtTopOfNode,
  $selectDecoratorNode,
  getTopLevelNativeElement,
} from '@/ui/inkling-editor/utils'
import { $insertAndSelectNode } from '@/ui/inkling-editor/utils/$insertAndSelectNode'
import { shouldIgnoreEvent } from '@/ui/inkling-editor/utils/shouldIgnoreEvent'

interface OpenCardInEditModePayload {
...
interface LinkMatchPayload {
  linkMatch: RegExpMatchArray
}

interface CardKeyboardEvent extends KeyboardEvent {
  _fromNested?: boolean
...
function $removeOrReplaceNodeWithParagraph(editor: LexicalEditor, node: CardNode) {
