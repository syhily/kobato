...
import { useInklingTextEntity } from '@/ui/inkling-editor/hooks/useInklingTextEntity'
import { $createTKNode, $isTKNode, ExtendedTextNode, TKNode } from '@/ui/inkling-editor/nodes/base'
import { SELECT_CARD_COMMAND } from '@/ui/inkling-editor/plugins/InklingBehaviourPlugin'
...
function TKIndicator({
  ...
  return (
    <div
      className="text-2xs absolute cursor-pointer p-1 font-medium text-grey-600"
