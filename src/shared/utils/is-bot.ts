// Bot detection — replaces the `isbot` package. Two fail-soft consumers:
// `entry.server` (bots get `onAllReady` instead of a streamed shell) and
// analytics enrichment (bot UAs excluded from visitor stats).
