...
// In-process cache of decoded thumbhash styles — many mounts share one decode.
...
// fades behind the real image; `undefined` until the decode finishes. Server
// snapshot is undefined — decode happens on the client only.
