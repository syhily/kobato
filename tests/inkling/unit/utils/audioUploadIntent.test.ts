...
import { AudioNode, $createAudioNode, type AudioNode as AudioNodeType } from '@/inkling/nodes/AudioNode'
import { audioUploadIntent } from '@/inkling/nodes/upload-intent'
import { getAudioMetadata } from '@/inkling/utils/getAudioMetadata'

vi.mock('@/inkling/utils/getAudioMetadata', () => ({
