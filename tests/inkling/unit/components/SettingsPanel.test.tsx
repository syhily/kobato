...
import type { CardConfig } from '@/inkling/context/InklingHostIntegrationContext'
...
vi.mock('@/inkling/context/InklingHostIntegrationContext', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/inkling/context/InklingHostIntegrationContext')>()
