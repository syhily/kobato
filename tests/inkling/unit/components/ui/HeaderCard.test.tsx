...
import { createDragHandler, createUploader } from '#/inkling/utils/mock-file-factories'
import { HeaderCard } from '@/inkling/components/ui/cards/HeaderCard/HeaderCard'

vi.mock('@/inkling/components/ui/MediaUploader', () => ({
...
vi.mock('@/inkling/components/ui/SettingsPanel', () => ({
...
vi.mock('@/inkling/components/InklingNestedEditor', () => ({
