...
import { drainEnqueuedUpdates } from '#/inkling/utils/test-editor'
import DEFAULT_NODES from '@/inkling/nodes/DefaultNodes'
import { $createFootnoteRefNode, $isFootnoteRefNode } from '@/inkling/nodes/footnote/FootnoteRefNode'
...
import {
  ...
  $syncFootnoteIndices,
  registerFootnotes,
} from '@/inkling/plugins/behaviour/footnotes'
