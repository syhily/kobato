...
import { $isImageNode, type BaseImageNode } from '@/inkling/nodes/base/nodes/image/ImageNode'
...
import { dataSrcToFile } from '@/inkling/utils/dataSrcToFile'
import { getImageDimensions } from '@/inkling/utils/getImageDimensions'

vi.mock('@/inkling/utils/dataSrcToFile', () => ({
  dataSrcToFile: vi.fn(),
}))
