...
import { createFootnoteHandle, type FootnoteHandle } from '@/inkling/plugins/behaviour/footnoteHandle'
import { $collectFootnoteSnapshot, registerFootnotes } from '@/inkling/plugins/behaviour/footnotes'
