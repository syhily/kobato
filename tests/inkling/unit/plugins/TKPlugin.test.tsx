...
import CardContext, { type CardContextValue } from '@/inkling/context/CardContext'
...
import { ExtendedTextNode, TKNode } from '@/inkling/nodes/base'
import { getTKMatch } from '@/inkling/plugins/behaviour/tk-matcher'
import { createTKHandle, type TKHandle } from '@/inkling/plugins/behaviour/tkHandle'
import TKPlugin from '@/inkling/plugins/TKPlugin'

vi.mock('@lexical/react/LexicalComposerContext', () => ({
  useLexicalComposerContext: vi.fn(),
}))

vi.mock('@/inkling/hooks/useInklingTextEntity', () => ({
