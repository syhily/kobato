...
import type { SlashMenuVerdict } from '@/inkling/plugins/behaviour/card-menu-trigger'

import { useCardMenuSession, type CardMenuSessionSelection } from '@/inkling/hooks/useCardMenuSession'
import { useSlashCardMenuTrigger } from '@/inkling/hooks/useSlashCardMenuTrigger'
import { registerSlashCardMenuTrigger } from '@/inkling/plugins/behaviour/card-menu-trigger'

vi.mock('@/inkling/plugins/behaviour/card-menu-trigger', async (importOriginal) => {
  const original = await importOriginal<typeof import('@/inkling/plugins/behaviour/card-menu-trigger')>()
