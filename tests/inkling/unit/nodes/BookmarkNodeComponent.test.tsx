...
import { BookmarkNode, $createBookmarkNode, $isBookmarkNode } from '@/inkling/nodes/BookmarkNode'
import { BookmarkNodeComponent } from '@/inkling/nodes/BookmarkNodeComponent'
...
vi.mock('@/inkling/utils/analytics', () => ({
  default: vi.fn(),
}))
