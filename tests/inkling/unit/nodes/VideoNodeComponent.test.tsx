...
import { createCardSelectionStoreWrapper } from '#/inkling/utils/card-selection-store'
import { createHostIntegrationValue } from '#/inkling/utils/host-integration-context'
import { tick, updateEditor } from '#/inkling/utils/test-editor'
import { InklingHostIntegrationProvider, type FileUploader } from '@/inkling/context/InklingHostIntegrationContext'
import MINIMAL_NODES from '@/inkling/nodes/MinimalNodes'
import { VideoNode, $createVideoNode } from '@/inkling/nodes/VideoNode'
import { VideoNodeComponent } from '@/inkling/nodes/VideoNodeComponent'
import { EDIT_CARD_COMMAND } from '@/inkling/plugins/behaviour/commands'
import extractVideoMetadata from '@/inkling/utils/extractVideoMetadata'

vi.mock('@/inkling/utils/extractVideoMetadata', () => ({
  default: vi.fn(),
}))
