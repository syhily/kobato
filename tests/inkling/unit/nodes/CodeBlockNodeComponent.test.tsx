...
import { createTestEditor } from '#/inkling/utils/test-editor'
import { InklingHostIntegrationProvider, type CardConfig } from '@/inkling/context/InklingHostIntegrationContext'
...
import { CodeBlockNodeComponent } from '@/inkling/nodes/CodeBlockNodeComponent'
...
vi.mock('@/inkling/components/ui/CardCaptionEditor', () => ({
