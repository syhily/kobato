...
import { createDocument } from '#/inkling/nodes-base/test-utils/index'
import { editorTest } from '#/inkling/utils/test-editor'
import { DEFAULT_CONFIG, DEFAULT_NODES } from '@/inkling/nodes/base/index'
...
describe('Serializers: linebreak', function () {
  ...
  describe('import', function () {
    describe('Inside a paragraph', function () {
      it(
        '(non GDoc) default conversion between text',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) default conversion for breaks inside paragraphs',
        editorTest(
          () => editor,
          function () {
    ...
    describe('Between paragraphs', function () {
      it(
        '(non GDoc) default conversion between paragraphs',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) no conversion for breaks between paragraphs',
        editorTest(
          () => editor,
          function () {
    ...
    describe('Between lists and paragraphs', function () {
      it(
        '(non GDoc) default conversion for linebreaks between unordered list and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between unordered list and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><ul><li>Item</li></ul><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
      ...
      it(
        '(non GDoc) default conversion for linebreaks between ordered list and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between ordered list and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><ol><li>Item</li></ol><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
      ...
      it(
        '(non GDoc) default conversion for linebreaks between description list and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between description list and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><dl><li>Item</li></dl><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
    ...
    describe('Between headings and paragraphs', function () {
      it(
        '(non GDoc) default conversion for a linebreak between a H1 and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between H1 and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><h1>Heading</h1><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
      ...
      it(
        '(non GDoc) default conversion for a linebreak between a H2 and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between H2 and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><h2>Heading</h2><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
      ...
      it(
        '(non GDoc) default conversion for a linebreak between a H3 and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between H3 and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><h3>Heading</h3><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
      ...
      it(
        '(non GDoc) default conversion for a linebreak between a H4 and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between H4 and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><h4>Heading</h4><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
      ...
      it(
        '(non GDoc) default conversion for a linebreak between a H5 and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between H5 and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><h5>Heading</h5><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
      ...
      it(
        '(non GDoc) default conversion for a linebreak between a H6 and paragraph',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips linebreaks between H6 and paragraph',
        editorTest(
          () => editor,
          function () {
            const htmlString =
              '<div id="docs-internal-guid-1234"><p>Paragraph></p><br><h6>Heading</h6><br><p>Paragraph></p>'
            const document = createDocument(htmlString)
            const nodes = $generateNodesFromDOM(editor, document)
    ...
    describe('Multiple linebreaks', function () {
      it(
        '(non GDoc) default conversion for multiple linebreaks between paragraphs',
        editorTest(
          () => editor,
          function () {
      ...
      it(
        '(GDoc) skips empty paragraphs if there are multiple linebreaks',
        editorTest(
          () => editor,
          function () {
