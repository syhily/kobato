...
import { dom, createDocument, html } from '#/inkling/nodes-base/test-utils/index'
import { editorTest } from '#/inkling/utils/test-editor'
import { BaseAudioNode, $createBaseAudioNode, $isAudioNode, type ExportDOMOptions } from '@/inkling/nodes/base/index'
...
describe('BaseAudioNode', function () {
  ...
  beforeEach(function () {
    ...
    dataset = {
      src: '/content/audio/2022/11/inkling-lexical.mp3',
      title: 'Test Audio',
      duration: 60,
      mimeType: 'audio/mp3',
      thumbnailSrc: '/content/images/2022/11/inkling-audio-lexical.jpg',
    }
  ...
  describe('exportDOM', function () {
        ...
        async function () {
          ...
          await expectPrettifiedHtml(
            ...
            html`<div class="inkling-card inkling-audio-card">
              ...
              />
              <div class="inkling-audio-thumbnail placeholder inkling-audio-hide">
              ...
              <div class="inkling-audio-player-container">
                <audio src="/content/audio/2022/11/inkling-lexical.mp3" preload="metadata"></audio>
                <div class="inkling-audio-title">Test Audio</div>
                <div class="inkling-audio-player">
                  ...
                  <div class="inkling-audio-time">/<span class="inkling-audio-duration">1:00</span></div>
                  <input type="range" class="inkling-audio-seek-slider" max="100" value="0" /><button
                    class="inkling-audio-playback-rate"
                  ...
                  ><input type="range" class="inkling-audio-volume-slider" max="100" value="100" />
                </div>
              </div>
            </div>`,
          )
    ...
    it(
      'round-trips the duration through export and import in m:ss',
      editorTest(
        () => editor,
        async function () {
          const audioNode = $createBaseAudioNode({ ...dataset, duration: 125 })
          const { element } = audioNode.exportDOM(editor, exportOptions)
          const card = getHTMLElement(element)

          // the wire format is m:ss, matching the import spec's minutes*60+seconds
          // parse — raw seconds would reimport 60x too large
          expect(card.querySelector('.inkling-audio-duration')!.textContent).toBe('2:05')

          const document = createDocument(card.outerHTML)
          const nodes = $generateNodesFromDOM(editor, document) as BaseAudioNode[]

          expect(nodes.length).toBe(1)
          expect(nodes[0].duration).toBe(125)
        },
      ),
    )
            ...
            <div class="inkling-card inkling-audio-card">
              ...
              <div class="inkling-audio-player-container">
                ...
                <div class="inkling-audio-player">
                  ...
                  ><span class="inkling-audio-current-time">0:00</span>
                  <div class="inkling-audio-time">/<span class="inkling-audio-duration">60</span></div>
                  <input type="range" class="inkling-audio-seek-slider" max="100" value="0" /><button
                    class="inkling-audio-playback-rate"
                    aria-label="Adjust playback speed"
                  >
          ...
          const document = createDocument(html`
            <div class="inkling-card inkling-audio-card">
              <div class="inkling-audio-player-container">
                ...
                <div class="inkling-audio-title">Test Audio</div>
                <div class="inkling-audio-player">
                  <div class="inkling-audio-time">/<span class="inkling-audio-duration">abc:12</span></div>
                </div>
              </div>
            </div>
          `)
          ...
          const document = createDocument(html`
            <div class="inkling-card inkling-audio-card">
              <div class="inkling-audio-player-container">
                ...
                <div class="inkling-audio-title">Test Audio</div>
                <div class="inkling-audio-player">
                  <div class="inkling-audio-time">/<span class="inkling-audio-duration"> 1 : 02 </span></div>
                </div>
              </div>
            </div>
          `)
