...
import { analyticsSchema } from '@/server/domains/settings/sections/analytics'
import { commentsSchema } from '@/server/domains/settings/sections/comments'
import { contentSchema } from '@/server/domains/settings/sections/content'
import { fontsSchema } from '@/server/domains/settings/sections/fonts'
...
import { seoSchema } from '@/server/domains/settings/sections/seo'
import { sidebarSchema } from '@/server/domains/settings/sections/sidebar'
import { socialsSchema } from '@/server/domains/settings/sections/socials'
