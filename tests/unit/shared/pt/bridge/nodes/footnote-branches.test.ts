...
} from '@/shared/pt/bridge/nodes/footnote'
...
describe('shared/pt/bridge/nodes/footnote — synchronizeFootnoteIndices', () => {
...
describe('shared/pt/bridge/nodes/footnote — footnoteSyncSignature', () => {
