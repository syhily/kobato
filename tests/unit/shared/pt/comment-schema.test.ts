...
// The legacy PT comment schema still types pre-R12 rows (emails degrade them
// to escaped plain text from R14 on; the plain-text snippet helper dual-reads
// them until the R15 body backfill lands).
