import { loadAdminDashboardData } from '@kobato/server/http/loaders/dashboard'
import { titleMeta } from '@kobato/shared/seo/title-meta'
import { roleLabel } from '@kobato/shared/utils/roles'
import { QuickActions } from '@kobato/ui/admin/dashboard/QuickActions'
import { RecentDraftsCard } from '@kobato/ui/admin/dashboard/RecentDraftsCard'
import { RecentPublishedCard } from '@kobato/ui/admin/dashboard/RecentPublishedCard'
import { SearchReindexCard } from '@kobato/ui/admin/dashboard/SearchReindexCard'
import { StatsGrid } from '@kobato/ui/admin/dashboard/StatsGrid'
