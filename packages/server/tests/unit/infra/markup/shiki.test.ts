import { SHIKI_SUPPORTED_LANGUAGES, SHIKI_THEMES, createShikiHighlighter } from '@kobato/server/infra/markup/shiki'
...
// `src/server/infra/markup/shiki.ts`: the 36 explicit language registrations +
...
describe('infra/markup/shiki — fine-grained highlighter', () => {
