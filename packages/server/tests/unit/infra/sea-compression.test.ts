...
import { createEmbeddedAssetReader, type EmbeddedAssetSource } from '@kobato/shared/sea/reader'
...
// reader (`@kobato/shared/sea/reader` createEmbeddedAssetReader) must agree on
