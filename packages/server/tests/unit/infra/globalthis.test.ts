...
const DI_MODULES = [
  'packages/server/src/infra/db/database.ts',
  'packages/server/src/infra/db/migrate.ts',
  'packages/server/src/infra/storage/backends/s3.ts',
  'packages/shared/src/config/snapshot.ts',
] as const
