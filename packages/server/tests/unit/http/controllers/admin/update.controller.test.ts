...
vi.mock('@kobato/server/domains/update/service', () => serviceMocks)
vi.mock('@kobato/server/domains/update/job', () => jobMocks)
...
const { adminUpdateRouter } = await import('@kobato/server/http/controllers/admin/update.controller')
const { recordAuditEventFromContext } = await import('@kobato/server/domains/audit/services/record')
