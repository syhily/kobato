...
import { closeDatabase } from '@kobato/server/infra/db/database'
...
const { buildLoadContext } = await import('@kobato/server/http/middleware-pipeline')
...
// (`@kobato/server/http/request-context`) once per request; `buildLoadContext`
