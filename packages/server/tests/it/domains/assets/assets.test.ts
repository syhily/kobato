import type { BrandingObjectRef, SiteAssetBranding } from '@kobato/shared/config/types'
...
import { fetchBrandingObject } from '@kobato/server/domains/assets/services/storage'
