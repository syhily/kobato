...
const { bulkApproveCommentsByUser, bulkDeleteCommentsByUser } =
  await import('@kobato/server/domains/comments/services/moderate')
...
const { softDeleteCommentById } = await import('@kobato/server/domains/comments/services/moderate')
