import type { BlogSettingsBundle, BrandingObjectRef } from '@kobato/shared/config/types'
...
import { backup as backupTable } from '@kobato/server/infra/db/schema/backup'
import { image, music } from '@kobato/server/infra/db/schema/media'
...
const { getLocalStorageMigrationStats, migrateLocalToS3 } = await import('@kobato/server/domains/storage/migration')
