...
import { flushAccessLog } from '@kobato/server/domains/analytics/services/batcher'
import { flushPageViews } from '@kobato/server/domains/analytics/services/pv-batcher'
import { initAllBatchers, resetAllBatchers } from '@kobato/server/infra/db/batcher-registry'
import { ensureMetric, findMetricByTarget } from '@kobato/server/infra/db/operations/metric'
...
const { trackPageView, KOBATO_AID_COOKIE } = await import('@kobato/server/domains/analytics/track')
