...
import { __resetCacheCountersForTests, bumpCounter, getCounter, set } from '@kobato/server/infra/cache/registry'
            ...
            children: [
              {
                ...
                textStyle: '',
                children: [
                  { detail: 0, format: 0, mode: 'normal', style: '', text: 'scheduled', type: 'text', version: 1 },
                ],
              },
            ],
          },
