import type { auditLog } from '@kobato/server/infra/db/schema/config'
import type { z } from 'zod'

import { stripL3Markers } from '@kobato/server/domains/audit/privacy'
import { maskIp, maskUserAgent } from '@kobato/server/domains/audit/utils'
import { getBlogSettingsBundleSync } from '@kobato/shared/config/getters'
import { auditLogItemDto } from '@kobato/shared/contracts/audit'
