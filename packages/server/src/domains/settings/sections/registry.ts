...
import { analyticsSection } from '@kobato/server/domains/settings/sections/analytics'
import { assetsSection } from '@kobato/server/domains/settings/sections/assets'
import { backupSection } from '@kobato/server/domains/settings/sections/backup'
import { cacheSection } from '@kobato/server/domains/settings/sections/cache'
import { commentsSection } from '@kobato/server/domains/settings/sections/comments'
import { contentSection } from '@kobato/server/domains/settings/sections/content'
import { fontsSection } from '@kobato/server/domains/settings/sections/fonts'
import { generalSection } from '@kobato/server/domains/settings/sections/general'
import { limitsSection } from '@kobato/server/domains/settings/sections/limits'
import { mailSection } from '@kobato/server/domains/settings/sections/mail'
import { navigationSection } from '@kobato/server/domains/settings/sections/navigation'
import { newsletterSection } from '@kobato/server/domains/settings/sections/newsletter'
import { rateLimitSection } from '@kobato/server/domains/settings/sections/rate-limit'
import { securitySection } from '@kobato/server/domains/settings/sections/security'
import { seoSection } from '@kobato/server/domains/settings/sections/seo'
import { sidebarSection } from '@kobato/server/domains/settings/sections/sidebar'
import { socialsSection } from '@kobato/server/domains/settings/sections/socials'
import { webmentionsSection } from '@kobato/server/domains/settings/sections/webmentions'
import { DomainError } from '@kobato/server/infra/http/errors'
import { SECTION_TO_BUNDLE_KEY, SETTINGS_SECTIONS } from '@kobato/shared/config/sections'
