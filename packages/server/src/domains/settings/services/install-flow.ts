...
import type { AssetsSettings, SiteIdentitySettings } from '@kobato/shared/config/types'

import { ASSETS_STORAGE_INSTALL_DEFAULTS } from '@kobato/server/domains/settings/sections/assets'
import { buildDefaultSectionPayloads, SECTION_REGISTRY } from '@kobato/server/domains/settings/sections/registry'
import { upsertSetting } from '@kobato/server/infra/db/operations/setting'
