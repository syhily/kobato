import type { SectionMeta } from '@kobato/server/domains/settings/sections/registry'
import type { Database } from '@kobato/server/infra/db/database'
import type { Setting } from '@kobato/server/infra/db/types'
...
import { SECTION_REGISTRY, validateSectionDefaults } from '@kobato/server/domains/settings/sections/registry'
...
import { applySectionPatch, encryptSecretsInRow } from '@kobato/server/domains/settings/services/secrets-write'
import { sectionChangeHandler } from '@kobato/server/domains/settings/services/section-changes'
import { assertSectionPatchKeys, isRecord } from '@kobato/server/domains/settings/services/section-patch'
