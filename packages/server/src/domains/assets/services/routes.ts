import {
  ...
  DEFAULT_SVG_ETAG,
  type SvgSlot,
} from '@kobato/server/assets/defaults'
import { fetchBrandingObject, SLOT_CONTENT_TYPE } from '@kobato/server/domains/assets/services/storage'
import { NODE_ENV } from '@kobato/server/infra/config'
