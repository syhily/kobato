...
import type { UpdateJobStatus } from '@kobato/shared/contracts/update'

import { runSelfUpdate } from '@kobato/server/domains/update/pipeline'
import { DomainError } from '@kobato/server/infra/http/errors'
import { closeHttpServer, requestShutdown, restartServer } from '@kobato/server/infra/lifecycle'
