import type { ProviderTrack } from '@kobato/server/domains/music/providers/types'
import type { Database } from '@kobato/server/infra/db/database'
import type { MusicRow, NewMusic } from '@kobato/server/infra/db/types'
...
import {
  ...
  MAX_AUDIO_BYTES,
  MAX_COVER_BYTES,
} from '@kobato/server/domains/music/services/write/shared'
import {
  findMusicById,
