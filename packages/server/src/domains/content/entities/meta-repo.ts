import type { MetaCrud, MetaRowBase } from '@kobato/server/domains/content/entities/descriptor'
import type { LimitOffset } from '@kobato/server/domains/content/pagination'
import type { Database } from '@kobato/server/infra/db/database'
import type { page as pageMetaTable } from '@kobato/server/infra/db/schema/page'
import type { post as postMetaTable } from '@kobato/server/infra/db/schema/post'
import type { NewPageMeta, NewPostMeta } from '@kobato/server/infra/db/types'
