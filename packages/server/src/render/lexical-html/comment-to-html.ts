...
// string, so feeds and email sinks can render without a DOM. Lives in
// the server package (moved from the editor package in stage 4); the
// React twin stays in `@kobato/editor/lexical-html/LexicalCommentBody`.
//
