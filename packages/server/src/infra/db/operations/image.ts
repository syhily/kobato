...
import type { ImageRow, NewImage } from '@kobato/server/infra/db/types'

import { likeEscape } from '@kobato/server/infra/db/like-escape'
import { applyPage, assembleWhere, withUploader } from '@kobato/server/infra/db/operations/admin-list'
 ...
 * the post-mutation paths in `@kobato/server/domains/images/services/admin-read` so the admin
