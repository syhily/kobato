...
import type { NewNewsletterSubscriber, NewsletterSubscriberRow } from '@kobato/server/infra/db/types'

import { newsletterSubscriber } from '@kobato/server/infra/db/schema/newsletter'
