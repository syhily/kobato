import type { backup } from '@kobato/server/infra/db/schema/backup'
import type { comment } from '@kobato/server/infra/db/schema/comment'
import type { setting } from '@kobato/server/infra/db/schema/config'
import type { content } from '@kobato/server/infra/db/schema/content'
import type { friend } from '@kobato/server/infra/db/schema/friend'
import type { kvCache } from '@kobato/server/infra/db/schema/kv-cache'
import type { image, music } from '@kobato/server/infra/db/schema/media'
import type { like, metric } from '@kobato/server/infra/db/schema/metric'
import type { newsletterSubscriber } from '@kobato/server/infra/db/schema/newsletter'
import type { oneTimeToken } from '@kobato/server/infra/db/schema/one-time-token'
import type { page } from '@kobato/server/infra/db/schema/page'
import type { passkeyCredential } from '@kobato/server/infra/db/schema/passkey'
import type { post } from '@kobato/server/infra/db/schema/post'
import type { session } from '@kobato/server/infra/db/schema/session'
import type { category, tag } from '@kobato/server/infra/db/schema/taxonomy'
import type { user, verification } from '@kobato/server/infra/db/schema/user'
import type { webmention, webmentionInbox, webmentionOutbox } from '@kobato/server/infra/db/schema/webmention'
