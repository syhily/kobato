import type { ProcessImageInput, ProcessedImage } from '@kobato/server/infra/image/process-worker'
...
import { processImageInWorker, WorkerDomainError } from '@kobato/server/infra/image/process-worker'
