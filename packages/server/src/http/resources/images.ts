...
import { defaultAvatarUrl, resolveAvatarSize, serveAvatar } from '@kobato/server/domains/comments/services/avatar'
...
import { serveCalendar } from '@kobato/server/http/resources/calendar'
