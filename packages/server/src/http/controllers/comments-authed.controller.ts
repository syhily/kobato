import { asCommentItemWire } from '@kobato/server/domains/comments/projection'
import { listMyCommentEntities, loadMineCommentsPage } from '@kobato/server/domains/comments/services/mine-comments'
import {
  cancelOwnCommentDeletion,
  editOwnComment,
  requestOwnCommentDeletion,
} from '@kobato/server/domains/comments/services/moderate'
import { authedProc } from '@kobato/server/http/orpc-base'
import { ownCommentMutationDto } from '@kobato/shared/contracts/comments'
