import type { CountersDto, ViewsPoint } from '@kobato/shared/contracts/analytics'
import type { DraftSummary } from '@kobato/shared/contracts/dashboard'
import type { ListPendingDashboardOutput } from '@kobato/shared/types/comments'
import type { LoaderFunctionArgs } from 'react-router'

import { getAnalyticsReader } from '@kobato/server/bootstrap/analytics-lifecycle'
import { queryCounters } from '@kobato/server/domains/analytics/services/counters'
...
import { loadAdminPendingDashboard } from '@kobato/server/domains/comments/services/admin-query'
import { countMyComments } from '@kobato/server/domains/comments/services/mine-comments'
import { countPostMetas, listPostMetas } from '@kobato/server/domains/posts/services/admin-query'
import { getRequestContext } from '@kobato/server/http/request-context'
import { computeDateRange } from '@kobato/shared/contracts/analytics'
import { pickEmptyStateLine } from '@kobato/shared/contracts/dashboard'
