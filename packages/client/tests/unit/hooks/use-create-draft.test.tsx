...
import { useCreateDraft, type CreateDraftConfig } from '@kobato/client/hooks/use-create-draft'

const config: CreateDraftConfig<LexicalBody> = {
...
const emptyBody: LexicalBody = EMPTY_LEXICAL_BODY
...
describe('useCreateDraft — stability', () => {
  it('migrateToEditKey / clearDraft keep referential identity across renders', () => {
    installWindow()
    const results: ReturnType<typeof useCreateDraft<LexicalBody, typeof meta>>[] = []
    renderHook(
      () => {
