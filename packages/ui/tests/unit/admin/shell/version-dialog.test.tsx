...
import type { UpdateCheckResult, UpdateJobStatus } from '@kobato/shared/contracts/update'
...
vi.mock('@kobato/shared/config/version', () => ({
  APP_NAME: 'kobato',
  APP_VERSION: '6.4.0',
...
const { VersionDialog } = await import('@kobato/ui/admin/shell/VersionDialog')
