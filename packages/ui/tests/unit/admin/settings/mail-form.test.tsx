...
vi.mock('@kobato/shared/lib/blog-config-context', async () => {
  const actual = await vi.importActual<typeof import('@kobato/shared/lib/blog-config-context')>(
    '@kobato/shared/lib/blog-config-context',
  )
  return {
    ...actual,
...
const { MailForm } = await import('@kobato/ui/admin/settings/MailForm')
