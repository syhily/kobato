import type { CommentItemWire } from '@kobato/shared/contracts/comments'

import { EMPTY_LEXICAL_COMMENT_BODY } from '@kobato/shared/lexical/comment-schema'
import { commentFlags, type CommentIdentity } from '@kobato/ui/public/comments/comment-item/comment-flags'
