import type { AdminMusicDto, MetingSearchHit } from '@kobato/shared/contracts/music'
...
import { AlbumCard } from '@kobato/ui/admin/musics/AlbumCard'
import { Equalizer } from '@kobato/ui/admin/musics/Equalizer'
import { LyricsDisplay } from '@kobato/ui/admin/musics/LyricsDisplay'
import { MusicDetailView } from '@kobato/ui/admin/musics/MusicDetailView'
import { MusicLibraryHero } from '@kobato/ui/admin/musics/MusicLibraryHero'
...
import { ProgressSlider } from '@kobato/ui/admin/musics/ProgressSlider'
...
vi.mock('@kobato/ui/admin/musics/useMetingMusicSearch', () => ({
