...
import type { CommentActions } from '@kobato/ui/admin/comments/useCommentsController'

import { lexCommentBody } from '#/_helpers/lexical-body'
import { mockTanstackQuery } from '#/_helpers/mock-react-query'
import { renderInRouter, stableHtml } from '#/_helpers/render'

import { AdminCommentRow } from '@kobato/ui/admin/comments/AdminCommentRow'
import { CommentsView } from '@kobato/ui/admin/comments/CommentsView'
import { EditUserDialog } from '@kobato/ui/admin/comments/EditUserDialog'
...
vi.mock('@kobato/ui/admin/comments/useCommentsController', async () => {
  const actual = await vi.importActual<typeof import('@kobato/ui/admin/comments/useCommentsController')>(
    '@kobato/ui/admin/comments/useCommentsController',
  )
  return {
    ...actual,
...
function makeAdminComment(overrides: Partial<AdminComment> = {}): AdminComment {
  commentSeq += 1
  const body = lexCommentBody(`Comment body ${commentSeq}`)
  return {
