import type { MyCommentItem } from '@kobato/shared/types/comments'
...
// `@kobato/client/api/orpc-query` and shipped to the hook — but as long as the
...
describe('snapshot: MyCommentsView data-loaded', () => {
  ...
  it('renders the populated list when data resolves (covers the items.map branch)', () => {
    ...
    // Both comment bodies render through LexicalCommentBody.
