import type { AdminPageDetailDto } from '@kobato/shared/contracts/pages'
import type { PageMetaDraft } from '@kobato/shared/types/pages'

import { renderInRouter, renderToHtml, stableHtml } from '#/_helpers/render'

import { MetaSidebar } from '@kobato/ui/admin/pages/MetaSidebar'
...
vi.mock('@kobato/editor/engine/lexical/LexicalBodyEditor', () => ({
  LexicalBodyEditor: () => <div data-testid="page-body-editor">LexicalBodyEditor</div>,
}))

vi.mock('@kobato/ui/admin/shell/AdminShell', () => ({
  useAdminChrome: () => ({
    setFocused: () => {},
    setScrollTopLifted: () => {},
  }),
...
describe('snapshot: PageEditorShell', () => {
  it('renders create mode', () => {
    ...
    expect(html).toContain('LexicalBodyEditor')
  })
