import type { AdminPageDto } from '@kobato/shared/contracts/pages'
import type { AdminUserDto } from '@kobato/shared/contracts/users'
import type { PageFilterFieldKey } from '@kobato/ui/admin/pages/filter-fields'
import type { ActiveFilter } from '@kobato/ui/admin/shared/filterPillsReducer'

import { mockTanstackQuery } from '#/_helpers/mock-react-query'
import { renderInRouter, stableHtml } from '#/_helpers/render'

import { PagesView } from '@kobato/ui/admin/pages/PagesView'
...
vi.mock('@kobato/ui/admin/shared/filter-bar/useFilterPills', async () => {
  const actual = await vi.importActual<typeof import('@kobato/ui/admin/shared/filter-bar/useFilterPills')>(
    '@kobato/ui/admin/shared/filter-bar/useFilterPills',
  )
  return {
    ...actual,
