...
import { LikeButton, LikeShare } from '@kobato/ui/public/LikeActions'
...
vi.mock('@kobato/client/hooks/use-comment-guest', () => ({
  useCommentGuest: () => ({
    profile: null,
    saveProfile: vi.fn(),
    clearProfile: vi.fn(),
...
vi.mock('@kobato/ui/public/comments/LazyCommentBodyEditor', () => ({
