import type { SocialNetwork } from '@kobato/shared/config/socials'
import type { NavigationItem } from '@kobato/shared/config/types'

import { brandingVersion } from '@kobato/shared/config/utils'
import { useAssetsSettingsOptional, useSiteIdentity, useSocialsSettings } from '@kobato/shared/lib/blog-config-context'
import { Button } from '@kobato/ui/components/button'
import { IconButtonContent } from '@kobato/ui/components/icon-button-content'
import { SOCIAL_NETWORK_ICONS } from '@kobato/ui/icons/brand'
...
import { ThemeToggle } from '@kobato/ui/public/chrome/ThemeToggle'
import { UserMenu } from '@kobato/ui/public/chrome/UserMenu'
import { SearchIconButton } from '@kobato/ui/public/Search'
