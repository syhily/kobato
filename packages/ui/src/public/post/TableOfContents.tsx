import type { MarkdownHeading, TocOpts } from '@kobato/shared/utils/toc'

import { transitions } from '@kobato/client/lib/motion'
import { useSeoSettingsOptional } from '@kobato/shared/lib/blog-config-context'
import { generateToC } from '@kobato/shared/utils/toc'
import { LazyAnimatePresence, LazyMotionButton, LazyMotionDiv, LazyMotionSpan } from '@kobato/ui/components/lazy-motion'
import { cn } from '@kobato/ui/lib/cn'
import { TocItems } from '@kobato/ui/public/post/TocItems'
