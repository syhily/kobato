import type { MyCommentEntityOption, MyCommentItem, MyCommentsStatus } from '@kobato/shared/types/comments'
...
} from '@kobato/ui/admin/my/filter-fields'
    ...
    <AdminListPage>
      ...
      <MyEditCommentDialog
        target={
          editTarget
            ? (() => {
                const parsed = lexicalCommentBodySchema.safeParse(editTarget.body)
      ...
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="comment-content prose-blog prose prose-sm mt-2 max-w-none leading-copy wrap-break-word whitespace-normal">
            <LexicalCommentBody body={item.body} />
          </div>
