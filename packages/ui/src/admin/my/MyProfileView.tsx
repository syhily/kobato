...
import { roleLabel } from '@kobato/shared/utils/roles'
import { LoginMethodCard } from '@kobato/ui/admin/my/LoginMethodCard'
import { PasskeyManagementCard } from '@kobato/ui/admin/my/PasskeyManagementCard'
import { PasswordChangeForm } from '@kobato/ui/admin/my/PasswordChangeForm'
...
import { maskIp, maskUa } from '@kobato/ui/lib/mask'
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className={cn('font-medium', counts.pending > 0 && 'text-destructive')}>{counts.pending}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">申请删除</span>
                <span className={cn('font-medium', counts.deleteRequested > 0 && 'text-destructive')}>
