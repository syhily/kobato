import { formatTime } from '@kobato/ui/admin/musics/format-time'
import {
  useMusicPlayerActions,
  useMusicPlayerState,
  useMusicPlayerTime,
} from '@kobato/ui/admin/musics/MusicPlayerContext'
import { ProgressSlider } from '@kobato/ui/admin/musics/ProgressSlider'
import { LazyAnimatePresence, LazyMotionDiv } from '@kobato/ui/components/lazy-motion'
