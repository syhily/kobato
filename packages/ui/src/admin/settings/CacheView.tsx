...
import type { ReservedCacheBucketStats } from '@kobato/shared/contracts/cache'
import type { CacheBucketId, CacheBucketSlot, ClearCacheTarget } from '@kobato/shared/types/cache'

import { orpc } from '@kobato/client/api/client'
import { orpcQuery } from '@kobato/client/api/orpc-query'
import { BucketCard } from '@kobato/ui/admin/settings/cache/BucketCard'
import { type ClearStatus, idleClearStatus } from '@kobato/ui/admin/settings/cache/cache-status'
import { CacheStatusLine } from '@kobato/ui/admin/settings/cache/CacheStatusLine'
import { ConfirmClearDialog } from '@kobato/ui/admin/settings/cache/ConfirmClearDialog'
