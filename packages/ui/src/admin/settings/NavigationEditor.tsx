...
import type { FooterNavItem, NavigationSettings, SocialItem } from '@kobato/shared/config/types'

import { SOCIAL_NETWORK_META, SOCIAL_NETWORKS } from '@kobato/shared/config/socials'
import { SettingGroup } from '@kobato/ui/admin/settings/shell/SettingGroup'
import { SettingsCheckbox } from '@kobato/ui/admin/settings/shell/SettingsCheckbox'
...
import { Field, FieldLabel } from '@kobato/ui/components/field'
