...
import { CategoriesSkeleton, CategoryRow } from '@kobato/ui/admin/categories/CategoryRow'
...
import { resolveSortableMove, useSortableSensors } from '@kobato/ui/admin/shared/sortable'
