...
import { cva, type VariantProps } from '@kobato/ui/lib/cva'
  ...
  return (
    <fieldset
      ...
      className={cn(
        ...
        // Focus state.
        'has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:shadow-focus',
        // Error state.
