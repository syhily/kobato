...
import { MathBlockView } from '@kobato/editor/lexical-core/nodes/views/math-block-view'
import { MATH_DISPLAY_CLASS } from '@kobato/editor/lexical-html/manifest'
...
export class MathBlockNode extends DecoratorNode<ReactNode> {
  ...
  decorate(editor: LexicalEditor): ReactNode {
    return <MathBlockView node={this} editor={editor} />
  }
