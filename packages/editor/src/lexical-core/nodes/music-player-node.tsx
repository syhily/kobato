...
import { MusicPlayerView } from '@kobato/editor/lexical-core/nodes/views/music-player-view'
import { MUSIC_MISSING_PLACEHOLDER } from '@kobato/editor/lexical-html/manifest'
...
export class MusicPlayerNode extends DecoratorNode<ReactNode> {
  ...
  decorate(editor: LexicalEditor): ReactNode {
    return <MusicPlayerView node={this} editor={editor} />
  }
