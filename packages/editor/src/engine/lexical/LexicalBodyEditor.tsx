...
import { BODY_EDITOR_NAMESPACE, createBodyEditorConfig } from '@kobato/shared/lexical/body-config'
...
import { $createHorizontalRuleNode } from '@kobato/shared/lexical/nodes/horizontal-rule-node'
import { $createImageNode } from '@kobato/shared/lexical/nodes/image-node'
import { $createMusicPlayerNode } from '@kobato/shared/lexical/nodes/music-player-node'
import { isEmptyLexicalBody } from '@kobato/shared/lexical/validate'
import { unsafeCast } from '@kobato/shared/utils/unsafe-cast'
import { createLinkMatcherWithRegExp } from '@lexical/link'
// Side effect: register the decorator-node views (image / inline-math /
// math-block / music-player / footnote-ref) into the shared node-view
// registry so `decorate()` renders in-editor.
import '@kobato/editor/engine/lexical/node-views/register-node-views'
