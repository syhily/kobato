import { strategyToConfig, type SafeHtmlStrategy } from '@kobato/editor/engine/lib/sanitize-html-config'
import { sanitizeHtmlEngine } from '@kobato/editor/engine/lib/sanitize-html-engine.node'
