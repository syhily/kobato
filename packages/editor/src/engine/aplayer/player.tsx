import type { ArtistInfo, AudioInfo } from '@kobato/editor/engine/aplayer/types'

import { defaultThemeColor } from '@kobato/editor/engine/aplayer/constants'
import { PlaybackControls } from '@kobato/editor/engine/aplayer/controller'
import { useAudioControl } from '@kobato/editor/engine/aplayer/hooks/use-audio-control'
import { useNotice } from '@kobato/editor/engine/aplayer/hooks/use-notice'
import { useThemeColor } from '@kobato/editor/engine/aplayer/hooks/use-theme-color'
import { Lyrics } from '@kobato/editor/engine/aplayer/lyrics'
import { PauseIcon, PlayIcon, RightIcon } from '@kobato/editor/engine/icons/aplayer'
