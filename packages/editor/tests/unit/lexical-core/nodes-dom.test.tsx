...
import { $isFootnoteDefinitionNode } from '@kobato/editor/lexical-core/nodes/footnote-definition-node'
import { $isFootnoteRefNode } from '@kobato/editor/lexical-core/nodes/footnote-ref-node'
import { $isHorizontalRuleNode } from '@kobato/editor/lexical-core/nodes/horizontal-rule-node'
import { $isImageNode } from '@kobato/editor/lexical-core/nodes/image-node'
import { $isInlineMathNode } from '@kobato/editor/lexical-core/nodes/inline-math-node'
import { $isMathBlockNode } from '@kobato/editor/lexical-core/nodes/math-block-node'
import { $isMusicPlayerNode } from '@kobato/editor/lexical-core/nodes/music-player-node'
import { $isSolutionNode } from '@kobato/editor/lexical-core/nodes/solution-node'
import { $isTwoColumnNode } from '@kobato/editor/lexical-core/nodes/two-column-node'
...
// emit the render-manifest markup (`lexical-html/manifest.ts`) plus the
...
describe('editor/lexical-core/nodes — exportDOM contract', () => {
...
describe('editor/lexical-core/nodes — importDOM round-trip', () => {
