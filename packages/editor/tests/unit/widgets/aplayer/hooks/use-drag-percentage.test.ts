...
import { useDragPercentage } from '@kobato/editor/widgets/aplayer/hooks/use-drag-percentage'
import { computePercentage } from '@kobato/editor/widgets/aplayer/utils/compute-percentage'
...
describe('editor/widgets/aplayer/hooks/useDragPercentage — initial state', () => {
...
describe('editor/widgets/aplayer/hooks/useDragPercentage — drag lifecycle', () => {
