import { computePercentage, computePercentageOfY } from '@kobato/editor/widgets/aplayer/utils/compute-percentage'
import { describe, expect, it } from 'vitest'

describe('editor/widgets/aplayer/utils/compute-percentage', () => {
