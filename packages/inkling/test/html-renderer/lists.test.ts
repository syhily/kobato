...
describe('Lists', function () {
  ...
  it(
    ...
    shouldRender({
      ...
      output:
        '<ul><li>one<ol><li>two.one<ul><li>three.one</li><li>three.two</li></ul></li><li>two.three</li></ol></li><li>three</li></ul>',
    }),
  )
  ...
  it(
    ...
    shouldRender({
      ...
      output:
        '<ol><li>one<ul><li>two.one<ol><li>three.one</li><li>three.two</li></ol></li><li>two.three</li></ul></li><li>three</li></ol>',
    }),
  )

  it(
    'containing text formats',
    shouldRender({
      ...
      output:
        '<ol><li><strong>bold</strong></li><li><em>italic</em></li><li><strong><em>bold+italic</em></strong></li></ol>',
    }),
  )

  it(
    'ol with start value > 1',
    shouldRender({
