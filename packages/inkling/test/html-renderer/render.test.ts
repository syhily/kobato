...
describe('render()', function () {
  ...
  it(
    'removes a trailing empty paragraph if present',
    shouldRender({
  ...
  it(
    'removes a trailing paragraph with only whitespace if present',
    shouldRender({
...
describe('Special elements', function () {
  ...
  it(
    'multiple linebreaks fully wrapped with formats',
    shouldRender({
  ...
  it(
    'multiple linebreaks surrounded by formats',
    shouldRender({
  ...
  it(
    'linebreaks with links',
    shouldRender({
      input: `{"root":{"children":[{"children":[{"detail":0,"format":0,"mode":"normal","style":"","text":"Test","type":"text","version":1},{"type":"linebreak","version":1},{"children":[{"detail":0,"format":0,"mode":"normal","style":"","text":"a link","type":"text","version":1}],"direction":"ltr","format":"","indent":0,"type":"link","version":1,"rel":null,"target":null,"title":null,"url":"https://inkling.local"},{"detail":0,"format":0,"mode":"normal","style":"","text":" some text","type":"text","version":1}],"direction":"ltr","format":"","indent":0,"type":"paragraph","version":1}],"direction":"ltr","format":"","indent":0,"type":"root","version":1}}`,
      output: `<p>Test<br><a href="https://inkling.local">a link</a> some text</p>`,
    }),
  )

  it(
    'multiple linebreaks with links',
    shouldRender({
      ...
      output: `<p>Test<br><br><a href="https://inkling.local">a link</a> some text</p>`,
    }),
  )

  it(
    'linebreaks after multiple formats',
    shouldRender({
...
describe('Transforms', function () {
  it(
    'removes AtLink nodes when rendering',
    shouldRender({
