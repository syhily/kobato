...
test.describe('Paste behaviour', () => {
  ...
  test.describe('URLs', function () {
        ...
        html`
          <p>
            ...
            <a href="https://inkling.local" dir="ltr">
              <span data-lexical-text="true">https://inkling.local</span>
            </a>
      ...
      await assertHTML(
        ...
        html`
          <div data-lexical-decorator="true" contenteditable="false">
            <div data-inkling-card-editing="false" data-inkling-card-selected="true" data-inkling-card="callout">
              <div>
    ...
    test('pasted on blank paragraph creates embed/bookmark', async function () {
      await focusEditor(page)
      await pasteText(page, 'https://inkling.local/')
      // embed nodes are not available; URL paste falls back to a bookmark card
    ...
    test('pasted on a card shortcut avoids conversion', async function () {
      ...
      await assertHTML(
        ...
        html`
          <p dir="ltr">
            <span data-lexical-text="true">/embed https://inkling.local/</span>
          </p>
        `,
      )
      ...
      // embed nodes are not available; pressing Enter should not create any card
      await assertHTML(
        page,
        html` <p dir="ltr"><span data-lexical-text="true">/embed https://inkling.local/</span></p> `,
      )
    })
  })
  ...
  test.describe('Styles', function () {
    ...
    test('text alignment styles are stripped from headings on paste', async function () {
      ...
      await assertHTML(page, html` <h1 dir="ltr"><span data-lexical-text="true">Testing</span></h1> `, {
        ignoreClasses: false,
    ...
    test('text alignment styles are stripped from quotes on paste', async function () {
      ...
      await assertHTML(page, html` <blockquote dir="ltr"><span data-lexical-text="true">Testing</span></blockquote> `, {
        ignoreClasses: false,
        ignoreInlineStyles: false,
      })
    })
      ...
      await assertHTML(
        ...
        html`
          <p dir="ltr">
            ...
            <a href="https://inkling.local/" target="_blank" rel="noreferrer noopener" dir="ltr">
    ...
    test('ignores line breaks between paragraphs', async function () {
      ...
      await assertHTML(
        ...
        html`
          ...
          <p dir="ltr">
            <span data-lexical-text="true"> Here is the 2nd paragraph, followed by a line break then a heading. </span>
          </p>
          ...
          <ul>
            <li value="1" dir="ltr"><span data-lexical-text="true">List item 1</span></li>
            <li value="2" dir="ltr"><span data-lexical-text="true">List item 2</span></li>
          </ul>
          <p dir="ltr">
            <span data-lexical-text="true">
          ...
          <p dir="ltr">
            <span data-lexical-text="true"> Here is the 5th paragraph. End of the article. </span>
          </p>
          <p><br /></p>
        `,
      )
  ...
  test.describe('Inside cards', function () {
    test('pasting inside HTML card CodeMirror editor works', async function () {
      ...
      await paste(page, {
        ...
        'text/html':
          "<meta charset='utf-8'><div style=\"color: #abb2bf;background-color: #282c34;font-family: 'Operator Mono Lig', Menlo, Monaco, 'Courier New', monospace;font-weight: normal;font-size: 12px;line-height: 14px;white-space: pre;\"><div><span style=\"color: #7f848e;font-style: italic;\">ignore default Lexical behaviour</span></div></div>",
      })
