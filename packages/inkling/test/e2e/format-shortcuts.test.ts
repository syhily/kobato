...
test.describe('Editor keyboard shortcuts', () => {
  ...
  test.describe('text formatting shortcuts', function () {
    ...
    test('inline code', async function () {
      ...
      await assertHTML(
        page,
        html`<p dir="ltr">
          <code spellcheck="false" data-lexical-text="true"><span>test</span></code>
        </p>`,
      )
    })
    ...
    test('highlight', async function () {
      ...
      await assertHTML(
        page,
        html`<p dir="ltr">
          <mark data-lexical-text="true"><span>test</span></mark>
        </p>`,
      )
    })
  })
  ...
  test('quotes', async function () {
    ...
    await assertHTML(page, html` <p dir="ltr"><span data-lexical-text="true">test</span></p> `)
  })
  ...
  test('specific heading', async function () {
    ...
    await assertHTML(page, html` <h1 dir="ltr"><span data-lexical-text="true">test</span></h1> `)

    await page.keyboard.press(`Control+Alt+2`)

    await assertHTML(page, html` <h2 dir="ltr"><span data-lexical-text="true">test</span></h2> `)

    await page.keyboard.press(`Control+Alt+3`)

    await assertHTML(page, html` <h3 dir="ltr"><span data-lexical-text="true">test</span></h3> `)

    await page.keyboard.press(`Control+Alt+4`)

    await assertHTML(page, html` <h4 dir="ltr"><span data-lexical-text="true">test</span></h4> `)

    await page.keyboard.press(`Control+Alt+5`)

    await assertHTML(page, html` <h5 dir="ltr"><span data-lexical-text="true">test</span></h5> `)

    await page.keyboard.press(`Control+Alt+6`)

    await assertHTML(page, html` <h6 dir="ltr"><span data-lexical-text="true">test</span></h6> `)
