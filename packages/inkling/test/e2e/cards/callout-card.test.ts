...
test.describe('Callout Card', () => {
    ...
    await assertHTML(
      ...
      html`
        <div data-lexical-decorator="true" contenteditable="false">
          <div data-inkling-card-editing="false" data-inkling-card-selected="false" data-inkling-card="callout">
            <div>
  ...
  test('can edit callout card', async function () {
    ...
    const calloutCard = page.locator('[data-inkling-card="callout"]')
  ...
  test('can toggle emoji', async function () {
    ...
    await toggle.click()
    // click on data-inkling-card="callout"
    await page.click('[data-inkling-card="callout"]')
    await page.keyboard.type('Hello World')
  ...
  test('can change background color', async function () {
    ...
    // const colorPicker = page.locator(`[data-testid="color-picker-green"]`);
    // await colorPicker.click();

    // // ensure data-testid="callout-bg-blue" is visible
  ...
  test('can toggle edit', async function () {
    ...
    const calloutCard = page.locator('[data-inkling-card="callout"]')
    await expect(calloutCard).toHaveAttribute('data-inkling-card-editing', 'true')
  })
  ...
  test('keeps focus on previous editor when changing size opts', async function () {
    ...
    // Change color
    // await page.locator(`[data-testid="color-picker-green"]`).click();
    await selectNamedColor(page, 'green', 'color-options-button')
    ...
    const content = page.locator('[data-inkling-card="callout"]')
