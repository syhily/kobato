...
test.describe('Gallery card', () => {
    ...
    await assertHTML(
      ...
      html`
        <div data-lexical-decorator="true" contenteditable="false" data-inkling-card-width="wide">
          <div data-inkling-card-editing="false" data-inkling-card-selected="false" data-inkling-card="gallery">
            <figure>
              <div>
                <div data-gallery="true">
                  <div data-row="0">
                    <div data-image="true">
                      <img alt="Alt 1" height="2160" src="/content/images/2023/04/retreat-1.jpg" width="3840" />
                      <div>
                        <div>
                    ...
                    <div data-image="true">
                      <img alt="Alt 2" height="2160" src="/content/images/2023/04/retreat-2.jpg" width="3840" />
                      <div>
                        <div>
                          <button aria-label="Delete" type="button">
                            <svg></svg>
  ...
  test('can insert gallery card', async function () {
    ...
    await assertHTML(
      ...
      html`
        <div data-lexical-decorator="true" contenteditable="false" data-inkling-card-width="wide">
          <div data-inkling-card-editing="false" data-inkling-card-selected="true" data-inkling-card="gallery">
            <figure>
              <div>
                <div>
                  <div>
  ...
  test('can upload images', async function () {
    ...
    await page.click('[data-inkling-card="gallery"]')
  ...
  test('can undo/redo without losing nested editor content', async () => {
    ...
    // (Chrome for Testing may lose card selection after file upload)
    await page.locator('[data-inkling-card="gallery"]').click()
    await expect(page.locator('[data-inkling-card="gallery"][data-inkling-card-selected="true"]')).toBeVisible()
    ...
    await page.keyboard.press(`${ctrlOrCmd(page)}+z`)
    await expect(page.locator('[data-inkling-card="gallery"]')).toBeVisible()

    // verify the gallery content is preserved after undo
    await expect(page.locator('[data-testid="gallery-image"]')).toHaveCount(2)
    const captionEditor = page.locator('[data-inkling-card="gallery"] figcaption')
