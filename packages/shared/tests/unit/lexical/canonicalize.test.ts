...
import { areLexicalBodiesEquivalent, canonicalizeLexicalBodyShape } from '@kobato/shared/lexical/canonicalize'
import { convertPtBodyToLexical } from '@kobato/shared/lexical/mapping'
import { isEmptyLexicalBody, validateLexicalBody } from '@kobato/shared/lexical/validate'
...
describe('shared/lexical/validate — validateLexicalBody', () => {
...
describe('shared/lexical/canonicalize — canonicalizeLexicalBodyShape', () => {
...
describe('shared/lexical/canonicalize — areLexicalBodiesEquivalent', () => {
...
describe('shared/lexical/validate — isEmptyLexicalBody', () => {
...
describe('shared/lexical/canonicalize — R5 dialect fixes', () => {
