import type { SiteAssetBranding, SidebarSettings } from '@kobato/shared/config/types'

import { brandingVersion, extractXHandle, isSidebarWidgetEnabled } from '@kobato/shared/config/utils'
