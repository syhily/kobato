import type { BundleKey, SECTION_TO_BUNDLE_KEY, SettingsSection } from '@kobato/shared/config/sections'
...
import type { CacheBucketSlot, TunableCacheBucketId } from '@kobato/shared/types/cache'
