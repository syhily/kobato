...
import { createCommentEditorConfig } from '@kobato/shared/lexical/comment-config'
import { validateLexicalCommentBody } from '@kobato/shared/lexical/comment-validate'
...
// `./canonicalize.ts`; no footnote sync — comments carry no
// footnote registry):
//
