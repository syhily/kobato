...
import { MATH_INLINE_CLASS } from '@kobato/shared/lexical/html-manifest'
...
// attributes) and `decorate` (click-to-edit React view, registered by the
// editor engine through the shared node-view registry — this node class
// itself carries no React import).
...
export class InlineMathNode extends DecoratorNode<unknown> {
  ...
  decorate(editor: LexicalEditor): unknown {
    return renderNodeView(InlineMathNode, this, editor)
  }
