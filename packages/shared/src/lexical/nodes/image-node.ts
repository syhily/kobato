...
import { IMAGE_FIGURE_CLASS, IMAGE_LAYOUT_CLASS, IMG_DECODING, IMG_LOADING } from '@kobato/shared/lexical/html-manifest'
...
// media-library / layout / caption editing view, registered by the editor
// engine through the shared node-view registry — this node class itself
// carries no React import).
...
export class ImageNode extends DecoratorNode<unknown> {
  ...
  decorate(editor: LexicalEditor): unknown {
    return renderNodeView(ImageNode, this, editor)
  }
