...
// the decorate view is registered by the editor engine through the
// shared node-view registry (`../node-views`) — this node class itself
...
export class FootnoteRefNode extends DecoratorNode<unknown> {
  ...
  decorate(editor: LexicalEditor): unknown {
    return renderNodeView(FootnoteRefNode, this, editor)
  }
