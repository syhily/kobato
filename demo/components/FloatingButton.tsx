...
const FloatingButton = ({ isOpen, onClick }: FloatingButtonProps) => {
  return (
    <div
      className={`text-grey-600 fixed right-6 bottom-4 z-20 rounded px-2 py-1 font-mono text-sm tracking-tight transition-all duration-200 ease-in-out ${isOpen ? 'bg-transparent' : 'bg-white'}`}
    >
